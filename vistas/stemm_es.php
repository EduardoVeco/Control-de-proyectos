	...
	public static function stemm($word) {
		...
		if ($word_after0 == $word_after1) {
			...
			if ($word_after2a == $word_after1) {
				...
				} elseif (($suf = stemm_es::endsinArr($rv_txt, array('arían', 'arías', 'arán', 'arás', 'aríais', 'aría', 'aréis', 'aríamos', 'aremos', 'ará', 'aré', 'erían', 'erías', 'erán', 'erás', 'eríais', 'ería', 'eréis', 'eríamos', 'eremos', 'erá', 'eré', 'irían', 'irías', 'irán', 'irás', 'iríais', 'iría', 'iréis', 'iríamos', 'iremos', 'irá', 'iré', 'aba', 'ada', 'ida', 'ía', 'ara', 'iera', 'ad', 'ed', 'id', 'ase', 'iese', 'aste', 'iste', 'an', 'aban', 'ían', 'aran', 'ieran', 'asen', 'iesen', 'aron', 'ieron', 'ado', 'ido', 'ando', 'iendo', 'ió', 'ar', 'er', 'ir', 'as', 'abas', 'adas', 'idas', 'ías', 'aras', 'ieras', 'ases', 'ieses', 'ís', 'áis', 'abais', 'íais', 'arais', 'ierais', '  aseis', 'ieseis', 'asteis', 'isteis', 'ados', 'idos', 'amos', 'ábamos', 'íamos', 'imos', 'áramos', 'iéramos', 'iésemos', 'ásemos','ada','ado','aje','ción','dicción','ducción','dura','ección','epción','ido','ión','miento','ncia','ón','scripción','sición','sión','dad','tad','edad','era','ería','ez','eza','ía','idad','ismo','ncia','','ura','dor','dero','ero','ista','ado','ario','ía','ero','ería','able','áceo','aco','al','áneo','ante','ario','ente','iente','ento','érrimo','ible','ico','ífico','il','ino','ísimo','ivo','izo','oso','ear','ecer','ificar','ízar'))) != '') {
					$word = substr($word,0, -strlen($suf));
				}
			}
		}
