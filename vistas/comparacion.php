            ...
            <div class="formulario col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                <form action="">
                    ...
                    <div class="div div-cuerpo form-group mx-sm-12">
                        ...
                        <div class="row">
                            <div class="col-6 justify-content-left input-group">
                                <input class="txt text-buscar " type="text " name="buscar" placeholder="Buscar" />
                        ...
                        <br>
                        <button class="btn btn-boton-ext " type="button "><img class="fa fa-icon " src="../imagenes/comparar.png " /> Comparar proyectos</button>
                    </div>
                </form>
            </div>
        </div>
