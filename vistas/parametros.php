                    ...
                    <form action="conexion.php" method="POST" id="parametros">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mx-sm-7 pt-3 col-5">
                                <input type="number" class="txt spinner-input" id="min" name="min"value="<?php echo $min ?>" data-toggle="tooltip" data-placement="right" title="Modifica el porcentaje mínimo en el que un proyecto se pone en revisión" pattern="[0-9]{1,3}" min="1" max="100" required>
                                <br>
